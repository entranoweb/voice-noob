...
export interface Integration {
  ...
  enabled: boolean;
  isPopular?: boolean;
  isBuiltIn?: boolean; // Synthiq Voice built-in integration
  badge?: string; // Custom badge text (e.g., "Synthiq Voice", "Popular")
...
export const AVAILABLE_INTEGRATIONS: Integration[] = [
  // Built-in Synthiq Voice Tools (No external API needed)
  {
    id: "call_control",
    name: "Call Control",
    slug: "call-control",
